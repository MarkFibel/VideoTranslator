...
| **Tortoise TTS** (high-quality, neural voice cloning) | 4.2–4.8 | 3.4–4.2 | 0.90–0.97 | ~200–800 s (≈0.2–0.8 s/пред) — медленнее; генерация качественная | 8–24 GB (зависит от моделей) | Обычно требует GPU | Фокус на голос-клонирование с небольшой выборкой; очень большой вес |
